...
{
    const char* pszTimestamp = "This is the birth of BlockCoin...";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("f6a7cb0b60b1532437f0a839aa767410112bed050fbcee0b04e351127b641be3");
        ...
        consensus.defaultAssumeValid = uint256S("0xf6a7cb0b60b1532437f0a839aa767410112bed050fbcee0b04e351127b641be3"); //1441280
        ...
        genesis = CreateGenesisBlock(1707103559, 130870, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf6a7cb0b60b1532437f0a839aa767410112bed050fbcee0b04e351127b641be3"));
        assert(genesis.hashMerkleRoot == uint256S("0xc7620c73806d9feaf719f43a6a150858075c152349a67bc97e5f661a4db98646"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("seed-a.blockcoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.blockcointools.com");
        //vSeeds.emplace_back("dnsseed.blockcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x6b1d8719bb29c465779a75c7941a6767bdc65ea52597374b7fc56d52298d35f4"); //612653
        ...
        genesis = CreateGenesisBlock(1486949366, 991172, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6b1d8719bb29c465779a75c7941a6767bdc65ea52597374b7fc56d52298d35f4"));
        assert(genesis.hashMerkleRoot == uint256S("0xc7620c73806d9feaf719f43a6a150858075c152349a67bc97e5f661a4db98646"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.blockcointools.com");
        //vSeeds.emplace_back("seed-b.blockcoin.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x8ceef4e84172403a4ef59c86f59c87dc09690b832d973e150a4466bdb057478f"));
        assert(genesis.hashMerkleRoot == uint256S("0xc7620c73806d9feaf719f43a6a150858075c152349a67bc97e5f661a4db98646"));
