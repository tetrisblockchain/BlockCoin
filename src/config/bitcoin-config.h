...
#define PACKAGE_BUGREPORT "https://github.com/blockcoin-project/blockcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BlockCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BlockCoin Core 0.16.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "blockcoin"
