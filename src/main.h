...
static const int64 MAX_MONEY = 27751680 * COIN; // BlockCoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 7) / 250; // BlockCoin: Priority cutoff is 2 BlockCoin day / 250 bytes.
    }
