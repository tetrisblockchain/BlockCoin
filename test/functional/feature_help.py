...
"""Verify that starting blockcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start blockcoin with -h for help text")
        ...
        self.log.info("Start blockcoin with -version for version information")
